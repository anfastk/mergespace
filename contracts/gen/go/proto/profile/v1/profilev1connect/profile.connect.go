...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/anfastk/mergespace/contracts/gen/go/proto/profile/v1"
	http "net/http"
	strings "strings"
)
...
func NewProfileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProfileServiceClient {
	...
	profileServiceMethods := v1.File_proto_profile_v1_profile_proto.Services().ByName("ProfileService").Methods()
